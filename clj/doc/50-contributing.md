...
The intention is that institution-specific realizer functions are collected in [API contrib](../src/limabean/harvest/api/contrib), with field mappings defined in the [(example) config file](../../test-cases/kiwibank/config.edn) for the test.
